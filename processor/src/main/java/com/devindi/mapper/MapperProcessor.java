...
import com.devindi.mapper.generator.MapperGenerator;
...
public class MapperProcessor extends AbstractProcessor {
    ...
    private void createInterfaceImplementation(TypeElement interfaceElement) {
        MapperGenerator generator = new MapperGenerator(processingEnv);
        TypeSpec implSpec = generator.generateMapperSpec(interfaceElement);
